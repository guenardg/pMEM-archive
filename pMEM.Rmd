...
The ability of the model to predict mite species counts was proportional to the
mean abundance of the species in the sampling area ($F_{1,33} = 18.32$,
$P < 0.001$; with log-transformed mean abundance and predictability estimated as
...
species, provided that relevant descriptors are available.
